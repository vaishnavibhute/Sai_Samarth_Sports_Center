      ...
      <div class="sidebar">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="../Sample/index.html">Home</a>
                </li>
                 <li>
        ...
        <tr>
            <td>
                <asp:HyperLink ID="HyperLink3" runat="server" 
                    NavigateUrl="~/Product_Category.aspx">Product Category</asp:HyperLink>
            </td>
            <td>
                <asp:HyperLink ID="HyperLink9" runat="server" 
                    NavigateUrl="~/Report/frm_ProductCategory.aspx">Product Category</asp:HyperLink>
            </td>
            <td>
                <asp:HyperLink ID="HyperLink15" runat="server" 
                    NavigateUrl="~/Report/frm_Categorywiseproductmaster.aspx">Categorywise 
                Product Master</asp:HyperLink>
            </td>
            <td>
                <asp:HyperLink ID="HyperLink20" runat="server" 
                    NavigateUrl="~/Report/frm_DateWise_SaleMaster.aspx">Datewise Sale Master</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td>
                <asp:HyperLink ID="HyperLink4" runat="server" 
                    NavigateUrl="~/Product_master.aspx">Product Master</asp:HyperLink>
            </td>
            <td>
                <asp:HyperLink ID="HyperLink10" runat="server" 
                    NavigateUrl="~/Report/frm_Product_Master.aspx">Product Master</asp:HyperLink>
            </td>
            <td>
                <asp:HyperLink ID="HyperLink16" runat="server" 
                    NavigateUrl="~/Report/frm_CustomerwiseSaleMaster.aspx">Customerwise Sale Master</asp:HyperLink>
            </td>
            <td>
                <asp:HyperLink ID="HyperLink21" runat="server" 
                    NavigateUrl="~/Report/frm_DateWise_Payment.aspx">Datewise Payment</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td>
                <asp:HyperLink ID="HyperLink22" runat="server" NavigateUrl="~/Customer.aspx">Customer</asp:HyperLink>
            </td>
            <td>
            ...
            <td>
                <asp:HyperLink ID="HyperLink17" runat="server" 
                    NavigateUrl="~/Report/frm_ProductwiseSaleDetails.aspx">Productwise Sale Details</asp:HyperLink>
            </td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                <asp:HyperLink ID="HyperLink12" runat="server" 
                    NavigateUrl="~/Report/frm_Sale_Master.aspx">Sale Master</asp:HyperLink>
            </td>
            <td>
                <asp:HyperLink ID="HyperLink18" runat="server" 
                    NavigateUrl="~/Report/frm_SalewiseSaleDetails.aspx">Salewise Sale Details</asp:HyperLink>
            </td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                <asp:HyperLink ID="HyperLink13" runat="server" 
                    NavigateUrl="~/Report/frm_Sale_details.aspx">Sale Details</asp:HyperLink>
            </td>
            <td>
                <asp:HyperLink ID="HyperLink19" runat="server" 
                    NavigateUrl="~/Report/frm_Salewisepayment.aspx">Salewise Payment</asp:HyperLink>
            </td>
            <td>
                &nbsp;</td>
        </tr>
